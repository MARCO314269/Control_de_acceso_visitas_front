    ...
    <footer class="kilimanjaro_area"> 
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="kilimanjaro_part m-top-15">
                            ...
                            <ul class="kilimanjaro_links">
                                <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Términos & Condiciones</a></li>
                                ...
                                <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Política de privacidad de datos</a></li>
        ...
        <div class=" kilimanjaro_bottom_header_one section_padding_50 text-center">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p>© Todos los derechos reservados. 2021<br/>Sitio desarrollado por: <br/><a href="https://ultrasist.mx" target="_blank" style="color:#27ae60;">Ultrasist SA de CV<i aria-hidden="true"></i></a></p>
                    </div>
                </div>
            </div>
        </div>
